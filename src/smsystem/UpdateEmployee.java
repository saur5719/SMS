...
public class UpdateEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1288, 873));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql="update employee set firstname='"+firstname+"',lastname='"+lasttname+"',position='"+position+"',age='"+age+"',contact='"+contact+"',emailid='"+emailid+"',gender='"+gender+"',permanentaddress='"+permanentaddress+"',presentaddress='"+presentaddress+"'";
