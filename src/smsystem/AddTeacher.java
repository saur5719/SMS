...
private void connect() {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(1294, 865));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql="insert into teacher (firstname,lastname,position,age,contact,emailid,gender,permanentaddress,presentaddress) "
            + "values('"+firstname+"','"+lasttname+"','"+position+"','"+age+"','"+contact+"','"+emailid+"','"+gender+"','"+permanentaddress+"','"+presentaddress+"')";
